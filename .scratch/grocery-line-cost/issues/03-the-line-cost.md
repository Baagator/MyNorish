...
- [ ] The row reads `€5.98 · 2 × 500 gram` for two packs and is unchanged for one.
- [ ] A by-weight row reads the cost and the grocery's own weight.
- [ ] An unmatched row shows the "priced as one pack" note and nothing else changes.
- [ ] The Store heading is the sum of the Line Costs under it in both the flat and the grouped list, and a done line is left out.
- [ ] A grouped row of 300 g and 0.4 kg is priced as 700 g.
